...
Uses BASinMain, Utility, Display, LogWind, Sound, Evaluate, PrinterOutput, Profiling, CPUDisplay, BASinMidi;

Procedure LogPCRegisters;
Begin

  If Not StartLogging Then
     If Registers.PC = 40960 Then
        StartLogging := True;

  If StartLogging Then
     Filing.DebugLog(IntToStr(Registers.PC) + '-'+IntToStr(Registers.F And 215));
    ...
    32768: Begin // port $BFFD
              Case AYRegSelected Of
                ...
                13: Begin
                       ...
                       End;
                    End;
                14: Begin AYRegisters.R14 := Value; ShadowAYRegs.R14 := Value; MIDIGatherBits(Value); End;
