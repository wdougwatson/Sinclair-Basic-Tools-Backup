...
Type
  ...
  Function  EvaluateNum(Expression: String; Default: Integer): Extended;
  Function  EvaluateStr(Expression: String; Default: String): String;
...
Uses BASinMain, ROMUtils, BASSupport, Filing, Utility;
...
Begin
  ...
  While Not Finished and (Timer < Opt_EvalTimeOut) Do Begin
     ...
     If Timer >= Opt_EvalTimeOut Then Begin
        Expression.ResultType := 2;
        Expression.ResultNum := 1;
        Expression.ResultError := 0;
